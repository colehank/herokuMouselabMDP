  ...
  MouselabMDP = class MouselabMDP {
    ...
    startTimer() {
      ...
      interval = ifvisible.onEvery(1, () => {
        ...
        this.timeLeft -= 1;
        this.waitMessage.html(`请等待 ${this.timeLeft} 秒 。`);
      ...
      if (a === 'simulate') {
        ...
        if (!this.simulationMode) {
          ...
          if (this.defaultLowerMessage) {
            this.lowerMessage.html('用方向键来移动');
            this.lowerMessage.css('color', '#000');
          }
        }
    ...
    async clickState(g, s) {
      ...
      if (this.moved) {
        this.lowerMessage.html("<b>在开始移动后，不能使用节点探测器！</b>");
        this.lowerMessage.css('color', '#FC4754');
        return;
      }
    ...
    endTrial() {
      ...
      this.lowerMessage.html("您获得了 <span class=mouselab-score/> 在这轮游戏，\n<br>\n<b>按</b> <code>空格</code> <b>继续 。</b>");
